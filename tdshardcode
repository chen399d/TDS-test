...
getgenv().Maps = {["Crossroads"] = {"Farm", "Commander", "Ace Pilot", "Pyromancer", "Electroshocker"}}
maplist = {"Crossroads"}
...
TDS:Place('Farm', -23.91549301147461, 0.9999980926513672, 14.245380401611328, 0, 0, 3.0, false, 0, 0, 0, false)
...
TDS:Target(7, 10, "Random", 0, 29.0, false)
TDS:Target(7, 10, "Farthest", 0, 29.5, false)
...
TDS:Target(3, 12, "Farthest", 0, 30.5, false)
TDS:Target(3, 12, "Closest", 0, 29.0, false)
TDS:Target(3, 12, "Weakest", 0, 29.5, false)
TDS:Target(3, 12, "Strongest", 0, 28.0, false)
...
TDS:Target(3, 14, "First", 0, 35.5, false)
...
TDS:Target(11, 16, "Random", 0, 4.8, true)
TDS:Target(11, 16, "Farthest", 0, 3.3, true)
TDS:Target(3, 16, "Random", 0, 3.8, true)
TDS:Target(3, 16, "Farthest", 0, 2.3, true)
TDS:Target(3, 16, "Closest", 0, 2.8, true)
TDS:Upgrade(11, 17, 3, 0.0, false)
TDS:Upgrade(3, 17, 3, 0.3, false)
TDS:Target(3, 17, "Weakest", 3, 0.6, false)
TDS:Target(3, 17, "Strongest", 2, 59.1, false)
TDS:Upgrade(10, 17, 0, 3.0, true)
TDS:Target(3, 17, "Last", 0, 3.5, true)
TDS:Target(3, 17, "First", 0, 2.0, true)
